...
class TestOGRFeatureclass():
    ...
    def setup(cls):
        ...
        if lion_loc is None:
            ...
            TestHelpers.set_up_small_feature_class()
    ...
    def test_ogr_pg_to_featureclass(self):
        ...
        ogr_cmds.read_featureclass_pg(fc_name='lion_bayside', geodatabase=TestHelpers.test_data_folder_path(LION_GDB_PATH), tbl_name=tblname)
