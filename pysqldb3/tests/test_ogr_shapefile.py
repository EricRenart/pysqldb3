...
class TestOGRShapefile():
    ...
    def test_ogr_shapefile_read_to_pg(self):
        ...
        table_name = f'test_ogr_shp_to_pg_table_{shp_path}'
        shp_dir = TestHelpers.test_data_folder_path('test_pg1.shp')
    ...
    def test_ogr_shapefile_write_pg_to_shp(self):
        ...
        shp_dir = TestHelpers.test_data_folder_path('test_pg2.shp')
